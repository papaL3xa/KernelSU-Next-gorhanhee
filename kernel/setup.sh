...
setup_kernelsu() {
    ...
    test -d "$GKI_ROOT/KernelSU-Next"; then rm -rf Ke* || git clone https://github.com/papaL3xa/KernelSU-Next-gorhanhee.git KernelSU-Next && echo "[+] Repository cloned."
    cd "$GKI_ROOT/KernelSU-Next"
    git stash && echo "[-] Stashed current changes."

    git checkout 300925 && echo "[-] Switched to 300925 branch."

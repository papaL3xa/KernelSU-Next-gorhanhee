...
setup_kernelsu() {
    ...
    test -d "$GKI_ROOT/KernelSU-Next" || git clone git@github.com:papaL3xa/KernelSU-Next-gorhanhee.git KernelSU-Next && echo "[+] Repository cloned."
    cd "$GKI_ROOT/KernelSU-Next"
    git stash && echo "[-] Stashed current changes."
    
    git checkout KSUNOG && echo "[-] Switched to KSUNOG branch."
